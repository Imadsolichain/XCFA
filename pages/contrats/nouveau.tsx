...
export default function NouveauContratPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      const res = await fetch('/api/contrats', {
        ...
        body: JSON.stringify({
          userId: undefined, // Removed user?.id
          email: undefined, // Removed user?.primaryEmailAddress?.emailAddress
          firstname: undefined, // Removed user?.firstName
          lastname: undefined, // Removed user?.lastName
          type,
          statut,
        }),
      });
      ...
      const pdfRes = await fetch('/api/generate-pdf', {
        ...
        body: JSON.stringify({
          type: 'contrat',
          data: {
            nom: undefined, // Removed user?.lastName
            prenom: undefined, // Removed user?.firstName
  ...
  return (
    <Layout title="Nouveau contrat">
      {/* contenu création contrat, auth désactivée */}
