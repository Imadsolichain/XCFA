...
export default function ApprentissagePage() {
  ...
  useEffect(() => {
    async function fetchContrats() {
      ...
      setContrats(Array.isArray(data) ? data.filter(c => c.type === 'apprentissage' && c.userId === 'mock') : []);
      setLoading(false);
    }
    fetchContrats();
  }, [submitting]);
  ...
  return (
    <Layout title="Apprentissage">
      <div className="max-w-2xl mx-auto py-12">
        ...
        <h2 className="text-xl font-semibold mb-4 text-[#333]">Mes contrats d'apprentissage</h2>
